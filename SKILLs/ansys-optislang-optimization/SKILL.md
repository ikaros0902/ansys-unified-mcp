...
description: ANSYS optiSLang 代理模型與最佳化路由指引（已完整收斂至 ansys-optislang）。
Use when:
  - 需執行 DoE 抽樣、敏感度分析、MOP 代理模型或多目標最佳化。
  - 觸發關鍵字 (繁中/En): optiSLang, 代理模型, MOP, 敏感度分析, Pareto.
---

# ANSYS optiSLang 代理模型與最佳化導引

> [!NOTE]
> **架構整併導引**：
> 本技能已全面收斂至核心主技能 **[`ansys-optislang`](../ansys-optislang/SKILL.md)**。
